const wordleHintButton = document.getElementById("wordleHint");

wordleHintButton.addEventListener("click", async () => {
...
function giveWordleHint() {
  ...
  Array.prototype.slice.call(gameRows).forEach((gameRow) => {
    ...
    Array.prototype.slice.call(gameTiles).forEach((gameTile, tileIndex) => {
  ...
  console.log('Regex array:', regexArray)

  // filter out words that match the regex
